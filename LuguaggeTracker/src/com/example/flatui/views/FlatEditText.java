...
public class FlatEditText extends EditText implements Colors {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            int theme = a.getInt(com.example.luguaggetracker.R.attr.theme, FlatUI.DEFAULT_THEME);
            color = FlatUI.getColor(theme);

            style = a.getInt(com.example.luguaggetracker.R.styleable.CengaLabs_fieldStyle, 0);

...
public class FlatButton extends android.widget.Button implements Colors {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            theme = a.getInt(com.example.luguaggetracker.R.styleable.CengaLabs_theme, FlatUI.DEFAULT_THEME);
            color = FlatUI.getColor(theme);

            textAppearance = a.getInt(com.example.luguaggetracker.R.styleable.CengaLabs_textAppearance, textAppearance);
            padding = a.getDimensionPixelSize(com.example.luguaggetracker.R.styleable.CengaLabs_textPadding, padding);
            radius = a.getDimensionPixelSize(com.example.luguaggetracker.R.styleable.CengaLabs_cornerRadius, radius);
            isFullFlat = a.getBoolean(com.example.luguaggetracker.R.styleable.CengaLabs_isFullFlat, isFullFlat);

            fontId = a.getInt(com.example.luguaggetracker.R.styleable.CengaLabs_fontFamily, fontId);
            fontWeight = a.getInt(com.example.luguaggetracker.R.styleable.CengaLabs_fontWeight, fontWeight);
